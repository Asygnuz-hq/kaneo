...
import updateTimeEntry, { type UpdateTimeEntryRequest } from "@/fetchers/time-entry/update-time-entry";
...
export default function useUpdateTimeEntry() {
  ...
  return useMutation({
    mutationFn: ({ taskId, ...data }: UseUpdateTimeEntryVariables) => updateTimeEntry(data),
